export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'simperz',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Simperz',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'simperz.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://simperz.com',
